...
if exist "../logs/current/ATAS_SESSION_LOG.txt" (
    echo Backing up current session log...
    move "../logs/current/ATAS_SESSION_LOG.txt" "../logs/current/ATAS_SESSION_LOG_backup_%date:~-4,4%%date:~-10,2%%date:~-7,2%_%time:~0,2%%time:~3,2%%time:~6,2%.txt" 2>nul
)
