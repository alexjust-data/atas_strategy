...
namespace MyAtas.Indicators
{
    [DisplayName("04 + 06 + 08 (ATAS) - Minimal")]
    public class FourSixEightIndicator : Indicator
    {
        // ============================== PARAMETERS ==============================
        // Colors for GenialLine bicolor mode
        private MediaColor _genialUpColor = MediaColor.FromArgb(255, 0, 170, 0);   // green by default
        private MediaColor _genialDownColor = MediaColor.FromArgb(255, 210, 0, 0); // red by default

        [Category("Genial Line"), DisplayName("Bicolor: UP color")]
        ...
        [Category("Genial Line"), DisplayName("Bicolor: DOWN color")]
        ...
        // --- Correction zone (EMA8 vs Wilder8) ---
        ...
        [Category("Drawing"), DisplayName("EMA 8 Color (fixed)")]
        ...
        [Category("Drawing"), DisplayName("EMA 8 • Auto bicolor (up/down)")]
        ...
        [Category("Drawing"), DisplayName("EMA 8 • Bicolor: UP color")]
        ...
        [Category("Drawing"), DisplayName("EMA 8 • Bicolor: DOWN color")]
        ...
        [Category("Drawing"), DisplayName("Wilder 8 Color (fixed)")]
        ...
        [Category("Drawing"), DisplayName("Wilder 8 • Auto bicolor (up/down)")]
        ...
        [Category("Genial Line"), DisplayName("Band Candles")]
        ...
        [Category("Genial Line"), DisplayName("Deviation")]
        ...
        [Category("Genial Line"), DisplayName("Auto bicolor (up/down)")]
        ...
        [Category("Tunnel Domenec"), DisplayName("Show Tunnels (all)")]
        ...
        [Category("Divergences"), DisplayName("Divergence Periods (N)")]
        ...
        private int _pHL = 8;
        [Category("Divergences"), DisplayName("Highest/Lowest Period (p)")]
        public int PHl { get => _pHL; set { var v = Math.Max(1, value); if (_pHL == v) return; _pHL = v; RecalculateValues(); } }

        private int _q = 3, _r2 = 5;
        [Category("Divergences"), DisplayName("DEMA Period (q)")] public int Q  { get => _q;  set { var v = Math.Max(1, value); if (_q  == v) return; _q  = v; RecalculateValues(); } }
        [Category("Divergences"), DisplayName("DEMA Period (r)")] public int R2 { get => _r2; set { var v = Math.Max(1, value); if (_r2 == v) return; _r2 = v; RecalculateValues(); } }

        private bool _showDivergences = true;
        [Category("Divergences"), DisplayName("Show Divergences")]
        ...
        // --- Color bars by Williams %R / ADX ---
        private bool _enableCandleColors = true;
        [Category("Color bars"), DisplayName("Color candles (Bullish/bearish change + map)")]
        ...
        [Category("Color bars"), DisplayName("Williams %R Period")]
        ...
        // ======== Individual switches per condition ========
        private bool _enCambioAlcista = true;
        [Category("Color bars  •  *** BULLISH ***"), DisplayName("🡹  BULLISH Change")]
        ...
        [Category("Color bars  •  *** BULLISH ***"), DisplayName("🡹🡹🡹  Up - STRONG FORCE")]
        ...
        [Category("Color bars  •  *** BULLISH ***"), DisplayName("🡹🡹  Up - MEDIUM FORCE")]
        ...
        [Category("Color bars  •  *** BULLISH ***"), DisplayName("🡹  Up - No Force")]
        ...
        [Category("Color bars  •  *** BULLISH ***"), DisplayName("🡻  Down - Momentum Stop - CORRECTION")]
        ...
        [Category("Color bars  •  *** BULLISH ***"), DisplayName("🡻  Down - No Force")]
        ...
        [Category("Color bars  •  *** BEARISH ***"), DisplayName("🡻  BEARISH Change")]
        ...
        [Category("Color bars  •  *** BEARISH ***"), DisplayName("🡻🡻🡻  Down - STRONG FORCE")]
        ...
        [Category("Color bars  •  *** BEARISH ***"), DisplayName("🡻🡻  Down - MEDIUM FORCE")]
        ...
        [Category("Color bars  •  *** BEARISH ***"), DisplayName("🡻  Down - No Force")]
        ...
        [Category("Color bars  •  *** BEARISH ***"), DisplayName("🡹  Up - Momentum Stop - CORRECTION")]
        ...
        [Category("Color bars  •  *** BEARISH ***"), DisplayName("🡹  Up - No Force")]
        ...
        [Category("Color bars • Colors (BULLISH)"), DisplayName("🡹  BULLISH Change")] public MediaColor ColCambioAlcista { get => _colCambioAlcista; set { if (_colCambioAlcista.Equals(value)) return; _colCambioAlcista = value; RecalculateValues(); } }
        [Category("Color bars • Colors (BULLISH)"), DisplayName("🡹🡹🡹  Up - STRONG FORCE")] public MediaColor ColSubeFuerzaGrandeA { get => _colSubeFuerzaGrandeA; set { if (_colSubeFuerzaGrandeA.Equals(value)) return; _colSubeFuerzaGrandeA = value; RecalculateValues(); } }
        [Category("Color bars • Colors (BULLISH)"), DisplayName("🡹🡹  Up - MEDIUM FORCE")] public MediaColor ColSubeFuerzaMediaA { get => _colSubeFuerzaMediaA; set { if (_colSubeFuerzaMediaA.Equals(value)) return; _colSubeFuerzaMediaA = value; RecalculateValues(); } }
        [Category("Color bars • Colors (BULLISH)"), DisplayName("🡹  Up - No Force")] public MediaColor ColSubeSinFuerzaA { get => _colSubeSinFuerzaA; set { if (_colSubeSinFuerzaA.Equals(value)) return; _colSubeSinFuerzaA = value; RecalculateValues(); } }
        ...
        [Category("Color bars • Colors (BEARISH)"), DisplayName("🡻  BEARISH Change")] public MediaColor ColCambioBajista { get => _colCambioBajista; set { if (_colCambioBajista.Equals(value)) return; _colCambioBajista = value; RecalculateValues(); } }
        [Category("Color bars • Colors (BEARISH)"), DisplayName("🡻🡻🡻  Down - STRONG FORCE")] public MediaColor ColBajaFuerzaGrandeB { get => _colBajaFuerzaGrandeB; set { if (_colBajaFuerzaGrandeB.Equals(value)) return; _colBajaFuerzaGrandeB = value; RecalculateValues(); } }
        [Category("Color bars • Colors (BEARISH)"), DisplayName("🡻🡻  Down - MEDIUM FORCE")] public MediaColor ColBajaFuerzaMediaB { get => _colBajaFuerzaMediaB; set { if (_colBajaFuerzaMediaB.Equals(value)) return; _colBajaFuerzaMediaB = value; RecalculateValues(); } }
        [Category("Color bars • Colors (BEARISH)"), DisplayName("🡻  Down - No Force")] public MediaColor ColBajaSinFuerzaB { get => _colBajaSinFuerzaB; set { if (_colBajaSinFuerzaB.Equals(value)) return; _colBajaSinFuerzaB = value; RecalculateValues(); } }

        // --- Trend shading (GenialLine) ---
        private bool _trendShading = false;
        [Category("Color bars • GenialLine"), DisplayName("Trend bicolor (light/dark)")]
        ...
        [Category("Color bars • GenialLine"), DisplayName("Auto derive tones")]
        ...
        [Category("Color bars • GenialLine"), DisplayName("Bullish: UP candle (light)")] public MediaColor UpTrendUpBarLight { get => _upTrendUpBarLight; set { if (_upTrendUpBarLight.Equals(value)) return; _upTrendUpBarLight = value; RecalculateValues(); } }
        [Category("Color bars • GenialLine"), DisplayName("Bullish: DOWN candle (dark)")] public MediaColor UpTrendDownBarDark { get => _upTrendDownBarDark; set { if (_upTrendDownBarDark.Equals(value)) return; _upTrendDownBarDark = value; RecalculateValues(); } }
        [Category("Color bars • GenialLine"), DisplayName("Bearish: DOWN candle (light)")] public MediaColor DownTrendDownBarLight { get => _downTrendDownBarLight; set { if (_downTrendDownBarLight.Equals(value)) return; _downTrendDownBarLight = value; RecalculateValues(); } }
        [Category("Color bars • GenialLine"), DisplayName("Bearish: UP candle (dark)")] public MediaColor DownTrendUpBarDark { get => _downTrendUpBarDark; set { if (_downTrendUpBarDark.Equals(value)) return; _downTrendUpBarDark = value; RecalculateValues(); } }

        private bool _paintByGenial = false;
        [Category("Color bars • GenialLine"), DisplayName("Color by GenialLine (above/below)")]
        ...
        [Category("Color bars • GenialLine"), DisplayName("GenialLine crosses only")]
        ...
        [Category("Color bars • GenialLine"), DisplayName("ABOVE color (state)")] public MediaColor ColAboveGenial { get => _colAboveGenial; set { if (_colAboveGenial.Equals(value)) return; _colAboveGenial = value; RecalculateValues(); } }
        [Category("Color bars • GenialLine"), DisplayName("BELOW color (state)")] public MediaColor ColBelowGenial { get => _colBelowGenial; set { if (_colBelowGenial.Equals(value)) return; _colBelowGenial = value; RecalculateValues(); } }
        [Category("Color bars • GenialLine"), DisplayName("BULLISH CROSS color")] public MediaColor ColCrossUp { get => _colCrossUp; set { if (_colCrossUp.Equals(value)) return; _colCrossUp = value; RecalculateValues(); } }
        [Category("Color bars • GenialLine"), DisplayName("BEARISH CROSS color")] public MediaColor ColCrossDown { get => _colCrossDown; set { if (_colCrossDown.Equals(value)) return; _colCrossDown = value; RecalculateValues(); } }
        ...
        private readonly ValueDataSeries _divBull = new("Bullish Divergence") { VisualType = VisualMode.Line, Width = 1, Color = MediaColor.FromArgb(255, 0, 150, 0) };
        private readonly ValueDataSeries _divBear = new("Bearish Divergence") { VisualType = VisualMode.Line, Width = 1, Color = MediaColor.FromArgb(255, 180, 0, 0) };
        ...
        // === Señal expuesta ===
        [Browsable(false)]
        public Signal468? LastSignal { get; private set; }

        private int _lastPublishedBar = -1;
        private Guid _lastPublishedUid = Guid.Empty;

        public enum TriggerKind { WPR_11_12, GenialLine }
        [Category("Signal Settings"), DisplayName("TriggerSource")]
        ...
        {
            DebugLog.Separator("INDICATOR INITIALIZATION");
            DebugLog.Critical("468/IND", $"Log file: {DebugLog.GetLogPath()}");
            DebugLog.Critical("468/IND", $"TriggerSource default: {TriggerSource}");
            ...
            // 👉 Apply base colors defined by the user
            _ema8.Color    = Ema8Color;     // or _ema8Color, if you prefer the field
            _wilder8.Color = Wilder8Color;  // or _wilder8Color
        ...
        protected override void OnCalculate(int bar, decimal value)
        {
            ...
            else
            {
                ...
                // ---- BLOQUE WPR/REGLA 11-12 (PINTADO + POSIBLE PUBLICACIÓN) ----
                if (crossUnder || crossOver)
                {
                    var trend = crossOver ? Trend.Up : Trend.Down;
                    DebugLog.Critical("468/IND", $"WPR CROSS detected: {trend} at bar={bar} (trigger={TriggerSource})");
                    
                    // ✅ ANTI-DUPLICATES: NO cortar el cálculo del bar
                    bool __skipPublish = bar <= _lastPublishedBar;
                    if (__skipPublish)
                    {
                        DebugLog.W("468/IND", $"SKIP duplicate PAINT: bar={bar} <= lastPublished={_lastPublishedBar}");
                    }

                    // Construir la señal
                    var candleForSignal = GetCandle(bar);
                    var sig = new Signal468
                    {
                        ...
                        Trend    = trend,
                        Source   = "PAINT",
                        PriceRef = candleForSignal
                    };

                    // Publicar solo si NO es duplicado Y si WPR es el trigger activo
                    if (!__skipPublish && TriggerSource == TriggerKind.WPR_11_12)
                    {
                        DebugLog.Critical("468/IND", $"PUBLISH WPR SIGNAL: bar={bar} dir={(crossOver ? "BUY" : "SELL")} uid={sig.Uid}");
                        LastSignal = sig;
                        _lastPublishedBar = bar;
                        _lastPublishedUid = sig.Uid;
                    }
                    else if (!__skipPublish)
                    {
                        DebugLog.W("468/IND", $"WPR signal NOT published (TriggerSource={TriggerSource})");
                    }
                }
            ...
            // === Per-bar colors for EMA8 / Wilder8 ===
            // (we use the slope vs previous cached value)
            ...
            if (Ema8AutoBicolor)
                ...
                _ema8.Colors[bar] = ToD(Ema8Color); // respect the fixed color from panel

            if (Wilder8AutoBicolor)
                _wilder8.Colors[bar] = (w8 >= prevW8) ? ToD(W8UpColor) : ToD(W8DownColor);
            else
                _wilder8.Colors[bar] = ToD(Wilder8Color); // fixed color from panel


            // Up/Down fills without touching the per-bar color of EMA8
            if (Ema8Len > 0 && e8 >= w8)
            {
            ...
            // ---- BLOQUE GENIAL LINE (GL_PAINT) ----
            if (crossUpGL || crossDownGL)
            {
                var trend = crossUpGL ? Trend.Up : Trend.Down;
                DebugLog.Critical("468/IND", $"GENIAL CROSS detected: {trend} at bar={bar} (trigger={TriggerSource})");
                DebugLog.W("468/IND", $"GenialLine values: c={c:F4} g9={g9:F4} cPrev={cPrev:F4} g9Prev={g9Prev:F4}");
                
                // ✅ ANTI-DUPLICATES: NO cortar el cálculo del bar
                bool __skipPublishGL = bar <= _lastPublishedBar;
                if (__skipPublishGL)
                {
                    DebugLog.W("468/IND", $"SKIP duplicate GL_PAINT: bar={bar} <= lastPublished={_lastPublishedBar}");
                }
                
                // Construir la señal
                var candleForGL = GetCandle(bar);
                var sig = new Signal468
                {
                    Uid      = Guid.NewGuid(),
                    BarId    = bar,
                    ...
                    Trend    = trend,
                    Source   = "GL_PAINT",
                    PriceRef = candleForGL
                };
                
                // Publicar solo si NO es duplicado Y el trigger es GenialLine
                if (!__skipPublishGL && TriggerSource == TriggerKind.GenialLine)
                {
                    DebugLog.Critical("468/IND", $"PUBLISH GENIAL SIGNAL: bar={bar} dir={(crossUpGL ? "BUY" : "SELL")} uid={sig.Uid}");
                    LastSignal = sig;
                    _lastPublishedBar = bar;
                    _lastPublishedUid = sig.Uid;
                }
                else if (!__skipPublishGL)
                {
                    DebugLog.W("468/IND", $"Genial signal NOT published (TriggerSource={TriggerSource})");
                }
            }
            ...
            // ✅ REMOVED: Old desynchronized signal publication logic
            // Signals are now published directly where candle colors are painted
            ...
            // ... (resto de cálculo y pintado de velas, series, caches, etc.)
        }
    ...
    // ====== Tipos auxiliares ======
    public enum Trend { Up, Down }
    
    public struct Signal468
    {
        public Guid Uid;
        public int BarId;
        ...
        public ATAS.Indicators.IndicatorCandle PriceRef;
    }
}